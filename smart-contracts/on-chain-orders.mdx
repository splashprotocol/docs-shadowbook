...
<Steps>
  ...
  <Step title="Build datum">
    Construct all fields except beacon. See [datum building](/smart-contracts/datum-building).
  </Step>
  <Step title="Calculate beacon">
    Use the first input UTxO reference and order index. See [beacon calculation](/smart-contracts/datum-building#beacon-calculation).
  </Step>
